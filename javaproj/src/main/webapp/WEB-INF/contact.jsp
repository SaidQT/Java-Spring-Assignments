        ...
        <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
          <div class="search-bar border rounded-2 px-3 border-dark-subtle">
            <form id="search-form" class="text-center d-flex align-items-center" action="" method="">
              <input type="text" class="form-control border-0 bg-transparent"
                placeholder="Search for your happiness" />
              ...
              <option>Toy</option>
						...
						<ul
							...
							<li style="padding: 0; margin: 0"><a href="index.html">
									...
									style="height: auto; width: 20%; padding: 0; margin: 0">
							</a></li>
                ...
                <a href="contact.html" class="nav-link">Contact Us</a>
							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu" aria-labelledby="Adoption">
							...
							<!--    <li><a href="wishlist.html" class="nav-link">Favourites</a></li> -->
		...
		<div class="container py-5 my-5">
			<div class="row">
				...
				<div class="contact-info col-lg-6 pb-3">
					<img src="images/banner-img.png" alt="cute"
						style="height: 100%; object-fit: cover; width: 72%;">
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="footer-menu">
						<img src="images/logo.png" class="img-fluid1 alt="logo" >
