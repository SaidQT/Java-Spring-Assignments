...
<body>
							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu" aria-labelledby="pages">
									<li><a href="about.html" class="dropdown-item">About
											Us<span class="badge bg-success text-dark ms-2">PRO</span>
									</a></li>
									...
									<li><a href="single-product.html" class="dropdown-item">Single
											Product<span class="badge bg-success text-dark ms-2">PRO</span>
									</a></li>
									...
									<li><a href="single-post.html" class="dropdown-item">Single
											Post<span class="badge bg-success text-dark ms-2">PRO</span>
									</a></li>
									...
									<li><a href="error.html" class="dropdown-item">Error
											404<span class="badge bg-success text-dark ms-2">PRO</span>
									</a></li>
	...
	<div class="card-containerr">
		<c:forEach var="pet" items="${pets}">
			<div class="cardd">
				<img src="${pet.imageUrl}" alt="Movie 1" id="dogs">
